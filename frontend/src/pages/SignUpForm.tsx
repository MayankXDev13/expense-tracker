...
export default function SignUpForm() {
  ...
  const onSubmit = (data: SignUpFormValues) =>
    signUp({ ...data, loginType: "EMAIL_PASSWORD" });
  ...
  return (
    <motion.div
      ...
      className="flex justify-center items-center min-h-screen bg-neutral-950 text-neutral-100 px-4"
    >
      <Card className="bg-neutral-900 border border-neutral-800 shadow-2xl w-full max-w-md rounded-2xl transition-transform duration-200 hover:scale-[1.01]">
        <CardHeader className="text-center space-y-2">
          ...
          <p className="text-sm text-neutral-400">Create an account</p>
        </CardHeader>
        ...
        <CardContent className="p-8 space-y-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={isPending}
              className="w-full bg-neutral-100 text-neutral-900 font-medium hover:bg-neutral-200 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-300 rounded-lg"
            >
